<template>
  <div class="page">
    <a-space direction="vertical" fill>
      <a-form :model="currentProject">
        ...
        <a-row :gutter="24">
          <a-col :span="8">
            <a-form-item field="start_time" label="开始" label-col-flex="30px">
              <a-input @input="queryProject" v-model="queryForm.keyword" placeholder="please enter..." />
            </a-form-item>
          </a-col>
          <a-col :span="8">
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="8">
            <a-button  type="primary" style="margin-right: 10px">点击搜索</a-button>
            ...
            <a-col :span="12">
              <a-form-item field="start_time" label="开始" label-col-flex="30px">
                <a-date-picker
                    ...
                    :time-picker-props="{ defaultValue: '09:09:06' }"
                    format="YYYY-MM-DD HH:mm:ss"
                    v-model:model-value="currentProject.start_time"
                />
              </a-form-item>
            </a-col>
            <a-col :span="12">
              <a-form-item field="value4" label="结束" label-col-flex="30px">
                <a-date-picker
                    ...
                    :time-picker-props="{ defaultValue: '09:09:06' }"
                    format="YYYY-MM-DD HH:mm:ss"
                    v-model:model-value="currentProject.deadline"
                />
              </a-form-item>
            </a-col>
          </a-row>
    ...
    maxRows:10
            ...
            <a-col :span="24">
              <a-steps changeable :current="2" @change="setCurrent">
      ...
      <template #footer>
        ...
        <a-button type="primary" @click="handleOk(currentProject)">确定</a-button>
      </template>
    </a-drawer>
  </div>
...
const queryProject = async ()=>{
  const {data} = await getProjectsApi(queryForm.value)
  Projects.value = data
}
</script>
<style>
